...
## Backgrounds
# colors['Hbb'] = ROOT.kRed-3
# colors['HSM'] = ROOT.kGreen-5
# colors['HWW'] = ROOT.kCyan-6
# colors['HZZ'] = ROOT.kBlue-6
# colors['p8_ee_WW_ecm240'] = ROOT.kYellow-6
# colors['p8_ee_ZZ_ecm240'] = ROOT.kGray
...
# colors['wzp6_ee_ssH_Hbb_ecm240'] = ROOT.kMagenta-4
# colors['wzp6_ee_ssH_Hcc_ecm240'] = ROOT.kAzure
# colors['wzp6_ee_ssH_Hgg_ecm240'] = ROOT.kCyan+3
# colors['wzp6_ee_ssH_Hmumu_ecm240'] = ROOT.kBlack-4
# colors['wzp6_ee_ssH_Hss_ecm240'] = ROOT.kSpring
# colors['wzp6_ee_ssH_Htautau_ecm240'] = ROOT.kTeal-1
# colors['wzp6_ee_bbH_Hbb_ecm240'] = ROOT.kBlue
# colors['wzp6_ee_bbH_Hcc_ecm240'] = ROOT.kGreen+3
# colors['wzp6_ee_bbH_Hgg_ecm240'] = ROOT.kTeal+4
# colors['wzp6_ee_bbH_Hmumu_ecm240'] = ROOT.kBlack-2
# colors['wzp6_ee_bbH_Hss_ecm240'] = ROOT.kCyan-3
# colors['wzp6_ee_bbH_Htautau_ecm240'] = ROOT.kWhite-5
# colors['wzp6_ee_ccH_Hbb_ecm240'] = ROOT.kGray
# colors['wzp6_ee_ccH_Hcc_ecm240'] = ROOT.kSpring-3
# colors['wzp6_ee_ccH_Hgg_ecm240'] = ROOT.kViolet-2
# colors['wzp6_ee_ccH_Hmumu_ecm240'] = ROOT.kBlack+4
# colors['wzp6_ee_ccH_Hss_ecm240'] = ROOT.kOrange+3
# colors['wzp6_ee_ccH_Htautau_ecm240'] = ROOT.kBlue-4
colors['wzp6_ee_eeH_Hbb_ecm240'] = ROOT.kRed+5
# colors['wzp6_ee_eeH_Hcc_ecm240'] = ROOT.kViolet+3
# colors['wzp6_ee_eeH_Hgg_ecm240'] = ROOT.kGreen-1
# colors['wzp6_ee_eeH_Hmumu_ecm240'] = ROOT.kBlue-2
# colors['wzp6_ee_eeH_Hss_ecm240'] = ROOT.kBlack+3
# colors['wzp6_ee_eeH_Htautau_ecm240'] = ROOT.kViolet+1
# colors['wzp6_ee_mumuH_Hbb_ecm240'] = ROOT.kTeal+1
# colors['wzp6_ee_mumuH_Hcc_ecm240'] = ROOT.kMagenta+1
# colors['wzp6_ee_mumuH_Hgg_ecm240'] = ROOT.kOrange-5
# colors['wzp6_ee_mumuH_Hmumu_ecm240'] = ROOT.kAzure-4
# colors['wzp6_ee_mumuH_Hss_ecm240'] = ROOT.kAzure-2
# colors['wzp6_ee_mumuH_Htautau_ecm240'] = ROOT.kRed-5
# colors['wzp6_ee_tautauH_Hbb_ecm240'] = ROOT.kSpring-5
# colors['wzp6_ee_tautauH_Hcc_ecm240'] = ROOT.kMagenta+3
# colors['wzp6_ee_tautauH_Hgg_ecm240'] = ROOT.kTeal-4
# colors['wzp6_ee_tautauH_Hmumu_ecm240'] = ROOT.kAzure-3
# colors['wzp6_ee_tautauH_Hss_ecm240'] = ROOT.kOrange-2
# colors['wzp6_ee_tautauH_Htautau_ecm240'] = ROOT.kAzure-1
# colors['wzp6_ee_nunuH_Hbb_ecm240'] = ROOT.kSpring+2
# colors['wzp6_ee_nunuH_Hcc_ecm240'] = ROOT.kViolet-4
# colors['wzp6_ee_nunuH_Hdd_ecm240'] = ROOT.kRed-3
# colors['wzp6_ee_nunuH_Hgg_ecm240'] = ROOT.kRed-4
# colors['wzp6_ee_nunuH_Hmumu_ecm240'] = ROOT.kBlack+1
# colors['wzp6_ee_nunuH_Hss_ecm240'] = ROOT.kMagenta+4
# colors['wzp6_ee_nunuH_Htautau_ecm240'] = ROOT.kSpring-1
# colors['wzp6_ee_nunuH_Huu_ecm240'] = ROOT.kPink+5
# colors['wzp6_ee_eeH_HZZ_ecm240'] = ROOT.kMagenta-3
# colors['wzp6_ee_mumuH_HZZ_ecm240'] = ROOT.kBlue-5
# colors['wzp6_ee_qqH_HZZ_ecm240'] = ROOT.kOrange
# colors['wzp6_ee_tautauH_HZZ_ecm240'] = ROOT.kSpring+1
# colors['wzp6_ee_eeH_HWW_ecm240'] = ROOT.kPink-3
# colors['wzp6_ee_mumuH_HWW_ecm240'] = ROOT.kGreen+2
# colors['wzp6_ee_qqH_HWW_ecm240'] = ROOT.kPink-2
# colors['wzp6_ee_tautauH_HWW_ecm240'] = ROOT.kBlack+5
...
# legend['Hbb'] = 'Z(ll/qq), H(bb)'
# legend['HSM'] = 'Other'
# legend['HWW'] = 'Z(ll/qq), H(WW)'
# legend['HZZ'] = 'Z(ll/qq), H(ZZ)'
