...
void ATLASLabel(Double_t x,Double_t y,const char* text,Color_t color) //, float size=0.055)
{
  ...
  // moving the text more to the right of "ATLAS"
  double delx = 0.10*696*gPad->GetWh()/(472*gPad->GetWw());
